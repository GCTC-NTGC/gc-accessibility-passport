...
const Share: React.FunctionComponent<ShareProps> = (props) => {
  ...
  const examples = [
    {
      label: intl.formatMessage({ defaultMessage: "My example file #1" }),
      value: "1",
    },
    {
      label: intl.formatMessage({ defaultMessage: "My example file #2" }),
      value: "2",
    },
    {
      label: intl.formatMessage({ defaultMessage: "My example file #3" }),
      value: "3",
    },
  ];
  return (
      ...
      <Page>
        <SectionOne>
          ...
          <p>
            {intl.formatMessage({
              defaultMessage:
                "Below you can select one or more of your documents to share with an individual. Once shared, an invitation will be sent, requiring them to accept. You can remove their access to your documents at any time.",
            })}
          </p>
          <Alert
          ...
          <ShareForm
            submitText={intl.formatMessage({
              defaultMessage: "Share the selected documents",
            })}
            checklistLabel={intl.formatMessage({
              defaultMessage: "Select one or more documents to share...",
            })}
          ...
          <div>
            <h2 data-h2-margin="b(all, none)" data-h2-font-size="b(h3)">
              {intl.formatMessage({
                defaultMessage: "Manage documents I’ve shared",
              })}
            </h2>
            <p>
              {intl.formatMessage({
                defaultMessage:
                  "The list below summarizes who has access to your documents. You can remove their access at any time.",
              })}
            </p>
            <div>
              <div
