  ...
  const history = [
    {
      ...
      message: intl.formatMessage({
        defaultMessage:
          "You linked “Example work situation #1” and “Example barrier #1” to this document.",
      }),
    },
    {
      date: new Date().toISOString().slice(0, 10),
      message: intl.formatMessage({
        defaultMessage: "You created this document.",
      }),
    },
  ];
        ...
        <SectionTwo>
          <div data-h2-display="b(flex)" data-h2-flex-direction="b(column)">
            ...
            <Alert
              ...
              message={intl.formatMessage({
                defaultMessage:
                  "Please note that by sharing this file, the recipient can see linked situations, barriers, and solutions.",
              })}
            />
            <div
